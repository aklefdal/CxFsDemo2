...
let website = "/CxFsDemo"

let githubLink = "https://github.com/aklefdal/CxFsDemo"

// Specify more information about your project
let info =
  [ "project-name", "CxFsDemo"
    "project-author", "Alf Kåre Lefdal"
    "project-summary", "Cx F# Demo"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/CxFsDemo" ]
